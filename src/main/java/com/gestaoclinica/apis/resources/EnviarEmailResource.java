...
public class EnviarEmailResource {
	...
	@PostMapping
	public String sendEnviarEmail(@RequestBody EnviarEmail enviarEmail, BindingResult bindingResult) {
		System.out.println("email0");

		if (bindingResult.hasErrors()) {
			System.out.println("email erro");
		...
		try {
			...
			} else if (enviarEmail.getTipoEmail() == 11) {
